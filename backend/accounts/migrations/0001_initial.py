# Generated by Django 4.2.18 on 2025-01-18 19:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mfa_secret', models.CharField(default=pyotp.random_base32, max_length=16)),
                ('email_verification_code', models.CharField(blank=True, max_length=64, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('share_link', models.CharField(blank=True, max_length=512, null=True)),
                ('expiration_time', models.DateTimeField(blank=True, null=True)),
                ('file', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='shared_files', to='accounts.uploadedfile')),
